...
class FaceDetectionScreenController extends GetxController {
  ...
  Future<void> initializeCamera() async {
    try {
      ...
      detectionStatus.value = 'Camera initialization error: ';
      update();
    }
  }
  ...
  Future<void> switchToInternalCamera() async {
    try {
      ...
      detectionStatus.value = 'Camera switch error: ';
    }
  }
  ...
  void _startInternalCameraDetection() {
    cameraController?.startImageStream((CameraImage image) async {
      ...
      try {
        ...
        detectionStatus.value = 'Processing error: ';
      } finally {
  ...
  Future<void> processImage(CameraImage image) async {
    try {
      ...
      detectionStatus.value = 'Error Processing}';
      stopAlarm();
    }
  }
